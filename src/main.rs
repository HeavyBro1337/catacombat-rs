...
use player::{camera::{setup_camera, spawn_fog, sync_camera}, control::move_player, player::PlayerLocation};
use gen::{location::WorldCatacomb, walker::{check_walkers, destroy_walker_generators, setup_walkers, walk_walker_generators}};
...
fn main() {
    ...
    .add_systems(Update, (sync_camera, move_player).run_if(in_state(GameState::Game)))
