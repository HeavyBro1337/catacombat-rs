...
fn main() {
    ...
    .add_systems(Startup, setup_walkers.run_if(in_state(NetworkState::Offline)))
    ...
    .add_systems(OnEnter(GameState::Game), setup_rooms.run_if(in_state(NetworkState::Offline)))
    .run();
}