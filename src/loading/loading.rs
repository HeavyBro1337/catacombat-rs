...
pub fn setup_loading(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    loading_assets.push(asset_server.load_untyped("sprites/doomguy.png").untyped());

    loading_assets.push(asset_server.load_untyped("sprites/cultist.png").untyped());

    loading_assets.push(asset_server.load_untyped("textures/wall.png").untyped());

    loading_assets.push(asset_server.load_untyped("textures/floor.png").untyped());

    loading_assets.push(asset_server.load_untyped("music/catacombs.mid").untyped());
